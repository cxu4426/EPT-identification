...
def main():
    ...
    #comment out for source model, use as target to fine tune
    freeze_three = freeze.copy.deepcopy(model) # target train only
    freeze.freeze_layers(freeze_three, 3) # target train only
